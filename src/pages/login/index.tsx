...
const Login = () => {
    return (
        <Layout>
            <main>
                <div
                    className="flex items-center min-h-screen p-4antialiased
      bg-gradient-to-r
      from-pink-300
      via-purple-300
      to-indigo-400 lg:justify-center"
                >
                    <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
                        <div className="p-4 py-6 text-white bg-violet-deeplilac md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
                            <div className="my-3 text-4xl font-bold tracking-wider text-center">
                                <a href="#">Divine</a>
                            </div>
                            <p className="mt-6 font-normal text-center text-gray-300 md:mt-0">
                                With the power of Divine, you can now focus only on functionaries for your digital products, while leaving the UI design on us!
                            </p>
                        ...
                        <div className="p-5 bg-white md:flex-1">
                            ...
                            <form action="#" className="flex flex-col space-y-5">
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-violet-deeplilac rounded-md shadow hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4"
                                    >
                                        Log in
                                    </button>
                                </div>
